...
def load_drift_data(csv_filepath: str, desired_offset_unit: str,
    ...
    fields = (mediator.DriftCompensatedMediator.CSV_FIELDS_V2 if uses_v2
              else mediator.DriftCompensatedMediator.CSV_FIELDS_V1)
...
def extract_metadata_row_v1(row: dict, desired_offset_unit: str,
    ...
    FIELDS = mediator.DriftCompensatedMediator.CSV_FIELDS_V1
...
def extract_metadata_row_v2(row: dict, desired_offset_unit: str,
    ...
    FIELDS = mediator.DriftCompensatedMediator.CSV_FIELDS_V2
...
def draw_drift_data_all(csv_file: str,
    ...
    This method reads a CSV file created by DriftCompensatedMediator, and
